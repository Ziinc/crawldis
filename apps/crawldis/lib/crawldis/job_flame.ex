defmodule Crawldis.JobFlame do
  @moduledoc false
  ...
  def init(crawl_job) do
    ...
    {:ok, _pid} =
      Registry.register(Crawldis.JobRegistry, crawl_job.id, crawl_job)

    {:ok, _pid} = FLAME.place_child(Crawldis.JobRunnerPool, {JobSup, crawl_job})
    {:ok, crawl_job}
  end
